  ...
  return (
    <div className="container">
      ...
      <div className="featuredContainer">
        ...
        <img alt="featured-project" className="featuredImg" src="https://res.cloudinary.com/darrin-im/image/upload/v1570337024/Screen_Shot_2019-10-06_at_12.41.05_AM_gdwkre.png"/>
